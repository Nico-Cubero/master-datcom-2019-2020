...
Script: test_HOG_SVM.py
Descripción: Clasifica las imágenes por medio de un clasificador SVM
	preentrenado y haciendo uso de descriptores HOG y las muestra por la
...
from eci import compute_HOG

#### Cuerpo del script ####

## Leer argumentos pasados al script
parser = argparse.ArgumentParser(description='Clasifica las imagenes '\
								 'especificadas por medio de un clasificador SVM'\
							 ' preentrenado y haciendo uso de descriptores HOG')
...
for img_filename in images_filename:
	...
	# Extraer descriptores HOG
	desc = compute_HOG(img)
