...
import json
import argparse
from eci import (load_image_class_dataset, compute_basic_LBP, train_svm, test_svm,
...
## Carga de imágenes y extracción de descriptores LBP
