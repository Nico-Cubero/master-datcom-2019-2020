...
import json
import argparse
from eci import (load_image_class_dataset, compute_uniform_LBP, train_svm,
				 test_svm, check_experiment_document,
				 extract_experiments_parameters)
...
parser = argparse.ArgumentParser(description='Entrena un clasificador SVM que'\
								 ...
								 ' fondo haciendo uso de descriptores LBP uniforme')
...
## Carga de imágenes y extracción de descriptores LBP uniformes
...
for p in svm_params:
	...
	print('Entrenamiento efectuado en {} s'.format(t_end-t_start))
