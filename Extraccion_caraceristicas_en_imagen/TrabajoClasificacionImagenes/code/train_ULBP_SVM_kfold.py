...
Script: train_ULBP_SVM_kfold.py
Descripción: Entrena clasificadores SVM que identifica imágenes con peatones
			e imágenes de fondo haciendo uso de descriptores LBP de tipo uniforme
			y evalúa su accuracy medio considerando un particionamiento kfold
			estratificado. Este script no guarda ningún modelo generado
Uso: train_ULBP_SVM_kfold.py <Documento JSON de experimentación>
...
## Carga de imágenes y extracción de descriptores LBP uniforme
