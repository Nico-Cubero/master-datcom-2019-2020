...
object Script_RUS_RandomForest {
    def main(arg: Array[String]) {
      
      //Configuración básica
      val jobName = "Random Forest con RUS"
       ...
       ************************/
      if (arg.length != 4) {
        System.err.println("Especificar: <Método de evaluación de impureza> <Número de árboles a generar> <Profundidad máxima del árbol> <Número máximo de bins>")
        System.exit(-1)
      }
      ...
      val modelRF = RandomForest.trainClassifier(trainRUS, numClasses, categoricalFeaturesInfo, numTrees,
      ...
      **************************/
      ...
      //para cluster
      val writer = new PrintWriter(s"/home/x20620439/results_RandomForest_impurity=$impurity-maxdepth=$maxDepth-max_Bins=$maxBins-numTrees=$numTrees-RUS.txt")
      writer.write(
        s"Métricas obtenidas sobre Random Forest con métrica de impureza '$impurity', profunidad máxima $maxDepth, número de bins máximos $maxBins, número de árboles $numTrees y RUS:\n" +
        "TRAIN:\n" +
