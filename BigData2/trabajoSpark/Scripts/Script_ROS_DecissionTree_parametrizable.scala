...
object Script_ROS_DecissionTree_parametrizable {
       def main(arg: Array[String]) {
      
      //Configuración básica
      val jobName = "DecissionTree con ROS"
       ...
       ************************/
      if (arg.length != 4) {
        System.err.println("Especificar: <ratio de sobremuestreo en ROS> <Método de evaluación de impureza> <Profundidad máxima del árbol> <Número máximo de bins>")
        System.exit(-1)
      }
      ...
      **************************/
      ...
      //para cluster
      val writer = new PrintWriter(s"/home/x20620439/results_DecissionTree_impurity=$impurity-maxdepth=$maxDepth-max_Bins=$maxBins-ROS=$overRate.txt")
      writer.write(
        s"Métricas obtenidas sobre DecissionTree con métrica de impureza '$impurity', profunidad máxima $maxDepth, número de bins máximos $maxBins, y ratio de sobremuestreo $overRate:\n" +
        "TRAIN:\n" +
