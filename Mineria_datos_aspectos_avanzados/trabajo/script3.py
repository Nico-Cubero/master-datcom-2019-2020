...
Las imágenes son cargadas en formato RGB
y cada uno de sus píxeles es reescalado a [0,1].
Uso: script3.py -d <Documento JSON con los experimentos a ejecutar> [-s]
...
desde el modelo "model1", hasta el modelo "model5" y desde el modelo "model13"
hasta el modelo "model64"
