...
El modelo usado es model_transfer_vgg16 que, usando transfer learning del modelo
VGG16 añade 3 capas densas entrenables para adaptarlo a este modelo.

Los entrenamientos se ejecutan sobre la CPU.
...
Uso: script7.py -d <Documento JSON con los experimentos a ejecutar> [-s]
...
for p in params:
	...
	model = models.model_transfer_vgg16()
