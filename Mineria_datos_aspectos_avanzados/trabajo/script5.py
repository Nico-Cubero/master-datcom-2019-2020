...
capas convolucionales, basándose en los modelos del modelo 65 de models.py
...
Uso: script5.py -d <Documento JSON con los experimentos a ejecutar> [-s]
...
from keras.callbacks.callbacks import History, ModelCheckpoint, ReduceLROnPlateau
...
for p in params:
	...
	model = models.model65_conv2d_filters(p)
	...
	rlrp = ReduceLROnPlateau(factor=0.5, patience=5, verbose=True)
