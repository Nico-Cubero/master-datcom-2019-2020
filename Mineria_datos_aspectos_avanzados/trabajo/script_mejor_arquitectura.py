...
Los modelos son generados a partir del modelo model68_def, la mejor arquitectura
encontada
...
Uso: script_mejor_arquitectura.py -d <Documento JSON con los experimentos a ejecutar> [-s]
