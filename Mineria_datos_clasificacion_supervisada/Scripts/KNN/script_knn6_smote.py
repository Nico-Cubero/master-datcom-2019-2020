...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 16 22:35:23 2020
...
## Redución de características basadas en árbol
# Convertir a números las variables categóricas
encoder = OrdinalEncoder()
encoder.fit(X_train_cat)

X_train_cat = encoder.fit_transform(X_train_cat)

# Usar un árbol para seleccionar características
tree = DecisionTreeClassifier()
tree.fit(X_train_cat, Y_train_values)

selecter = SelectFromModel(tree, prefit=True)

X_train_cat = selecter.transform(X_train_cat)
X_test_cat = selecter.transform(X_test_cat)
...
with open('./resultados14_knn_kfold.json', 'w') as f:
    json.dump(
            {
