...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 16 16:28:57 2020
...
smote = SMOTE(n_jobs=-1, sampling_strategy='auto', k_neighbors=17)

X_train, Y_train_values = smote.fit_resample(X_train, Y_train_values)
...
with open('./resultados13_knn_kfold.json', 'w') as f:
    json.dump(
            {
